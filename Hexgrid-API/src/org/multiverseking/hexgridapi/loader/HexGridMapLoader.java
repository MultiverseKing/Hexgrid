package org.multiverseking.hexgridapi.loader;
...
//        this.mapName = mapName;
        try {
            if (saveChunk(null)) {
                ...
                org.multiverseking.hexgridapi.loader.MapDataLoader mdLoader = new org.multiverseking.hexgridapi.loader.MapDataLoader();
...
//            cdLoader.setChunk(getChunkTiles(position));
    ...
    public boolean loadArea(String name) {
        ...
        org.multiverseking.hexgridapi.loader.MapDataLoader mdLoader = (org.multiverseking.hexgridapi.loader.MapDataLoader) assetManager.loadAsset("/Data/MapData/" + name + "/" + name + ".map");
//        Cleanup();
//        mapName = name;
