package org.multiverseking.hexgridapi.core.geometry;

import org.multiverseking.hexgridapi.core.geometry.buffer.HexGridBuffer;
import org.multiverseking.hexgridapi.core.geometry.buffer.BufferedChunk;
...
import org.multiverseking.hexgridapi.core.geometry.mesh.GreddyMesher;
    ...
    public void initialize(Application app, HexGridBuffer gridBuffer) {
        ...
        if (greddyMesher == null) {
            if (true) {//!app.getRenderer().getCaps().contains(Caps.TextureArray)) {
                ...
                mat = assetManager.loadMaterial("org/multiverseking/hexgridapi/assets/Materials/hexMat.j3m");
