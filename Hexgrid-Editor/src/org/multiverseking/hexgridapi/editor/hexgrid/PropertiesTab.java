...
import org.multiverseking.hexgridapi.editor.utility.gui.ComboBoxRenderer;
...
import org.multiverseking.hexgridapi.editor.hexgrid.gui.JCursorPositionPanel;
...
public final class PropertiesTab extends HexGridPropertiesPan {
    ...
    public PropertiesTab(EditorMain editorMain, HexGridAppState hexMapSystem, GridMouseControlAppState mouseSystem) {
        super(editorMain.getAssetManager().loadTexture(
                "org/multiverseking/hexgridapi/assets/Textures/Icons/Buttons/configKey.png").getImage(), "HexMapConfig");
